...
class SearchViewController: UIViewController {
    ...
    func parse(data: Data) -> [SearchResult] { // converts respose data from server to temporary array
        do {
    ...
    func showNetworkError() { // handles errors when netork requests dont work
...
extension SearchViewController: UISearchBarDelegate {
    // sends a network request to the itunes store
